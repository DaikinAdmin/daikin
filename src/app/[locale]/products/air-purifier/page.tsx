  ...
  const products = [
    {
      id: 'mc55w',
      icon: Wind,
      image: '/images/mc55w.jpg'
    },
    {
      id: 'mc70l',
      icon: Shield,
      image: '/images/mc70l.jpg'
    },
    {
      id: 'mcz70w',
      icon: Sparkles,
      image: '/images/mcz70w.jpg'
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#003D7A] mb-2">
                {t('technology.streamer.title')}
              </h3>
              <p className="text-gray-600">
                {t('technology.streamer.description')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#003D7A] mb-2">
                {t('technology.hepa.title')}
              </h3>
              <p className="text-gray-600">
                {t('technology.hepa.description')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#003D7A] mb-2">
                {t('technology.humidifying.title')}
              </h3>
              <p className="text-gray-600">
                {t('technology.humidifying.description')}
              </p>
            </div>
          </div>
        </div>
